...
<head>
    ...
    <title>{{ Setting::get('site.general.title') }}!</title>
...
<span class="preheader"
      style="box-sizing: border-box; display: none !important; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; mso-hide: all; opacity: 0; overflow: hidden; visibility: hidden;">
    {{ Setting::get('site.general.title') }}
    !</span>
            ...
            <table class="email-content" width="100%" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td class="email-masthead"
                        ...
                        align="center">
                        <a href="{{ \URL::to('/') }}" target="_blank" class="email-masthead_name"
                            ...
                            <tr>
                                <td class="content-cell"
                                    ...
                                    <p style="box-sizing: border-box; color: #74787E; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;"
                                       align="left">{!! _uit("email.welcome.Thanks") !!},
                                        <br/>
                                        <a href="{{ \URL::to('/') }}" target="_blank" class="email-masthead_name"
                                           style="box-sizing: border-box; color: #bbbfc3; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 white;">{{ Setting::get('site.general.title') }}</a>
                                    </p>

                                    <p style="box-sizing: border-box; color: #74787E; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 16px; line-height: 1.5em; margin-top: 0;"
                                       align="left">

                                        {!! _uit("email.welcome.Feel free to contact us on") !!}
                                        <a href="{{ \URL::to('/') }}" target="_blank"
                                           style="box-sizing: border-box; color: #3869D4; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif;">{{ \URL::to('/') }}</a>
                                    </p>
                                        ...
                                        <tr>
                                            <td style="box-sizing: border-box; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; word-break: break-word;">
                                                <p class="sub"
                                                   ...
                                                   align="left">
                                                    {!! _uit("email.welcome.This message is generated automatically based on your action on") !!}
                                                    <a href="{{ \URL::to('/') }}" target="_blank"
                                                       class="email-masthead_name"
                                                       style="box-sizing: border-box; color: #74787E; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 12px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 white;">{{ Setting::get('site.general.title') }}</a>
                                                    <br/>
                                                    {!! _uit("email.welcome.Please do not reply to this email") !!}
                            ...
                            <tr>
                                <td class="content-cell" align="center"
                                    ...
                                    <p class="sub align-center"
                                       ...
                                       align="center">© {{ date("Y") }} {{ Setting::get('site.general.title') }}
                                    </p>
                                    <p class="sub align-center"
                                       style="box-sizing: border-box; color: #AEAEAE; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 12px; line-height: 1.5em; margin-top: 0;"
                                       align="center">
                                        @if(Setting::get('site.footer.address') != "")
                                            {{ Setting::get('site.footer.address') }}
                                        @endif
                                    </p>
                                </td>
                            </tr>
