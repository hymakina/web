...
jQuery.extend(true,_R, {
	...
	resizeThumbsTabs : function(opt,force) {	
		...
		if ((opt.navigation && opt.navigation.tabs.enable) || (opt.navigation && opt.navigation.thumbnails.enable)) {
			...
			if (ckNO(othu) && (force || othu.width>othu.min_width || othu.fillHorizontal)) rtt(f,tws,opt.c,othu,opt.slideamount,'thumb');
			if (ckNO(otbu) && force) {
...
var rtt = function(f,tws,c,o,lis,wh) {	
	var h = c.parent().find('.tp-'+wh+'s'),
		...
		if (o.direction==="horizontal" && o.fillHorizontal) {
		   cw =   Math.ceil(((jQuery(window).width()-(o.wrapper_padding*2)) - (o.space*(o.visibleAmount-1))) / o.visibleAmount);
		}

		var ch = Math.round((cw/o.width) * o.height),
...
var addThumb = function(container,o,li,what,opt) {
	...
	var linkto = li.data('index'),
        ...
        if (o.direction==="horizontal" && o.fillHorizontal) {
           var thumbWidth =  Math.ceil(((jQuery(window).width()-(o.wrapper_padding*2)) - (o.space*(o.visibleAmount-1))) / o.visibleAmount);
            maxw = (thumbWidth * o.visibleAmount) + (o.space*(o.visibleAmount-1))
    	}

    var maxh = o.direction==="horizontal" ? o.height : (o.height * o.visibleAmount) + (o.space*(o.visibleAmount-1));

    if (o.direction==="horizontal" && o.fillHorizontal) {
        maxh = thumbWidth/(o.width/o.height) ;
    }
