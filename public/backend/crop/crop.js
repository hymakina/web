...
function empty(e) {
	...
	t.html5imageupload.prototype = {
		_init : function() {
			...
			if (n.options.onAfterInitImage)
				n.options.onAfterInitImage.call(n, n)
		},
		_bind : function() {
			var e = this;
			var n = e.element;
		...
		handleFile : function(e, n) {
			...
			if (i.removeurl != null && !empty(t(n).data("name"))) {
				t.ajax({
					...
					success : function(e) {
						if (r.options.onAfterRemoveImage)
							r.options.onAfterRemoveImage.call(r, e, r)
					}
				})
			}
			...
			if (r.options.onAfterSelectImage)
				r.options.onAfterSelectImage.call(r, response, r)
		},
		...
		imageUnhandle : function() {
			...
			if (e.options.onAfterMoveImage)
				e.options.onAfterMoveImage.call(e, e)
		},
				...
				y.onload = function() {
					...
					b.onload = function() {
						...
						if (s.save == false) {
							...
							t(n).find(".tools").children().toggle();
							if (e.options.onSave)
								e.options.onSave.call(e, t.extend(v, s.data, {
									data : w
								}));
							e.imageFinal()
						} else if (s.ajax == true) {
		...
		imageReset : function() {
			...
			e._ghost();
			if (e.options.onAfterResetImage)
				e.options.onAfterResetImage.call(e, e)
		},
		imageFinal : function() {
			var e = this;
			var n = e.element;
			...
			if (e.options.onAfterProcessImage)
				e.options.onAfterProcessImage.call(e, e)
		},
		...
		reset : function(data) {
			...
			if (i.removeurl != null && !empty(t(n).data("name"))) {
				t.ajax({
					...
					success : function(t) {
						if (e.options.onAfterRemoveImage)
							e.options.onAfterRemoveImage.call(e, t, e)
					}
				})
			}else if(e.options.onAfterProcessImage){
				e.ajaxresponse = data;
				e.options.onAfterProcessImage.call(e, e)
			}
			...
			if (e.options.onAfterCancel)
				e.options.onAfterCancel.call(e)
		},
		resize : function() {
			var e = this;
			var n = e.options;
			...
			if (s.buttonZoomin != false) {
				t(i).append(t(n.button.zoomin).on({
					...
					"touchend mouseup mouseleave" : function(t) {
						...
						if (n.options.onAfterZoomImage)
							n.options.onAfterZoomImage.call(n, n)
					}
				}))
			}
	...
	t.fn.html5imageupload = function(e) {
		if (t.data(this, "html5imageupload"))
			return;
