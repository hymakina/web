var TableDatatablesManaged = function () {
    var e = function () {
        ...
        e.dataTable({
            language: {
                ...
                info: "_TOTAL_ kayıt ve _START_ sayfadan _END_inci sayfa gösteriliyor",
                infoEmpty: "Kayıt bulunamadı",
                infoFiltered: "(filtered1 from _MAX_ total records)",
                lengthMenu: "Sayfada _MENU_ adet kayıt göster",
                search: "Ara:",
                zeroRecords: "Uygun kayıt bulunamadı",
                paginate: {previous: "Önceki", next: "Sonraki", last: "İlk", first: "Son"}
            },
            bStateSave: !0,
    ...
    }, managersStoneList = function () {
        var e = $("#manager_stone_list");
        e.dataTable({
            language: {
                aria: {
                    sortAscending: ": activate to sort column ascending",
        ...
        e.dataTable({
            ...
            pageLength: 5,
            pagingType: "bootstrap_full_number",
            columnDefs: [{orderable: !1, targets: [3]}, {searchable: !1, targets: [3]}, {className: "dt-right"}],
            order: [[1, "asc"]]
        });
        jQuery("#sample_1_wrapper");
        e.find(".group-checkable").change(function () {
        ...
        e.dataTable({
            ...
            pageLength: 5,
            pagingType: "bootstrap_full_number",
            columnDefs: [{orderable: !1, targets: [4]}, {searchable: !1, targets: [4]}, {className: "dt-right"}],
            order: [[1, "asc"]]
        });
    ...
    return {
        init: function () {
            jQuery().dataTable && (e(), managerStoneList(), ogrenci(), managerUser(), t(), a(), r(), o(), n())
        }
    }
}();
