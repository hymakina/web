...
use Modules\Contact\Entities\ContactTranslation;
...
class ContactServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Route::model('contact', '\Modules\Contact\Entities\Contact');

        Route::bind('contact_slug', function ($value, $route) {

            $result = \Modules\Contact\Entities\ContactTranslation::where('slug', $value)->firstOrFail();
            ...
            if($result && $result->slug == $value){
                return \Modules\Contact\Entities\Contact::whereTranslation('slug', $value)->firstOrFail();
            }
            abort(404);
